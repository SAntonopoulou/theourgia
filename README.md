...
As of close: **1705 vitest tests · 550 visual + 550 a11y baselines · 1473 backend tests · all green**.
...
| 04 | Journaling (entries, blog, library, body diagrams, quotes) | `[x]` (H02 frontend primitives B61-B66; Batch 36 folded in; **B97 Tiptap live editor + 6 custom block nodes shipped**) | [plan/04-journaling.md](plan/04-journaling.md) |
