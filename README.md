...
As of close: **1714 vitest tests · 552 visual + 552 a11y baselines · 1473 backend tests · all green**.
...
| 04 | Journaling (entries, blog, library, body diagrams, quotes) | `[x]` (H02 frontend primitives B61-B66; Batch 36 folded in; **B97-B99a Tiptap live editor + 8 custom block nodes + 9 slash commands shipped**) | [plan/04-journaling.md](plan/04-journaling.md) |
