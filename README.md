...
As of close: **1720 vitest tests · 556 visual + 556 a11y baselines · 1473 backend tests · all green**.
...
| 04 | Journaling (entries, blog, library, body diagrams, quotes) | `[x]` (H02 frontend primitives B61-B66; Batch 36 folded in; **B97-B99c Tiptap live editor · 8 custom block nodes · 9 slash commands · entity/library/chart pickers · persistence wired**) | [plan/04-journaling.md](plan/04-journaling.md) |
