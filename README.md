...
| | |
|---|---|
| **Latest commit** | `v1-025` — **2026-07-20 prod incident closed** (celery had never run in prod: six stacked defects fixed across v1-021→v1-025; first-ever restic snapshot verified in R2 with the database dump inside; webauthn RLS healed; frontend healthcheck green; incident report at docs/ops/INCIDENT-2026-07-20-celery-never-ran.md) · **Wave 2**: memorial auto-trigger + posthumous release + Shamir key-share (alembic 0079) · Beings ledger routes mounted from the H03 designs · on top of the 18-batch 2026-07-16 close-out wave (MBF · Whisper · 4 calendars · closed-tradition + entry tags · crisis nudge · Stream/Mux · bind-rune · email backends · FTS wired · divination persistence + trance · Helm · ops bundle · GDPR docs · 17 user docs · fresh-install fixes) |
